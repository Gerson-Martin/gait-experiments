...
constexpr auto DEFAULT_FOOT_LIFT = 0.03;    // [m]
...
const std::string NOMBRE_ARCHIVO2 = "/home/gerson/MATLAB-Drive/TrajectoriaGeneradaLocal.txt";
const std::string NOMBRE_ARCHIVO3 = "/home/gerson/MATLAB-Drive/TrayectoriaArticulares.txt";
const char DELIMITADOR =' ';
std::ofstream data1,data2,dataJoints;
...
int main(int argc, char * argv[])
{
    ...
    do
    {
        ...
        for (int i = 0; i < pointsLeft.size(); i++)
        {
            ...
            dataJoints<<i*period*2<<" "<<q[0]<<" " << q[1]<<" " << q[2]<<" " << q[3]<<" "<< q[4]<<" "<<q[5]<<" "
