    ...
    do
    {
        ...
        for (int i = 0; i < pointsLeft.size(); i++)
        {
             data1<<period*i<< DELIMITADOR << pointsLeft[i][0]<< DELIMITADOR << pointsLeft[i][1]<<DELIMITADOR<< pointsLeft[i][2]<< DELIMITADOR
                  ...
                  << "\n";
             dataVel<<period*i<<DELIMITADOR<<comTraj.Vel(period*i).vel[0]<<DELIMITADOR<<comTraj.Vel(period*i).vel[1]<<DELIMITADOR<<comTraj.Vel(period*i).vel[2]<<DELIMITADOR<<comTraj.Vel(period*i).rot[0]<<DELIMITADOR<<comTraj.Vel(period*i).rot[1]<<DELIMITADOR<<comTraj.Vel(period*i).rot[2]<<DELIMITADOR
                   <<leftTraj.Vel(period*i).vel[0]<<DELIMITADOR<<leftTraj.Vel(period*i).vel[1]<<DELIMITADOR<<leftTraj.Vel(period*i).vel[2]<<DELIMITADOR<<leftTraj.Vel(period*i).rot[0]<<DELIMITADOR<<leftTraj.Vel(period*i).rot[1]<<DELIMITADOR<<leftTraj.Vel(period*i).rot[2]<<DELIMITADOR
                   <<rightTraj.Vel(period*i).vel[0]<<DELIMITADOR<<rightTraj.Vel(period*i).vel[1]<<DELIMITADOR<<rightTraj.Vel(period*i).vel[2]<<DELIMITADOR<<rightTraj.Vel(period*i).rot[0]<<DELIMITADOR<<rightTraj.Vel(period*i).rot[1]<<DELIMITADOR<<rightTraj.Vel(period*i).rot[2]<<"\n";
        }
