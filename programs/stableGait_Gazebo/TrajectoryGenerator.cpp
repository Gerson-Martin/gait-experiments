...
//    liftLeg.p[0]+=distance;
    ...
    KDL::VelocityProfile_Trap* profFootSingle=new KDL::VelocityProfile_Trap(pathFootSingle->PathLength()/DURATION_TURN_ANGLE_COM/2,0.1/2);//new KDL::VelocityProfile_Rectangular((pathFootSingle->PathLength()/DURATION_TURN_ANGLE_COM));
