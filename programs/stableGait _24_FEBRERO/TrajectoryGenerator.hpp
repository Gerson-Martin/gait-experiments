...
private:
    ...
    void singleFootTrajectory(KDL::Trajectory_Composite & comTraj, KDL::Trajectory_Composite & LegInFlightTraj, KDL::Trajectory_Composite & staticLegTraj, KDL::Frame &LegInFlight, KDL::Frame &staticLeg, double &nStep);
    KDL::Path_Composite * getPathLegSwing(double h, KDL::Frame &step_start, KDL::Frame &step_end,KDL::Frame H, double nPoints);
    FootSpec footSpec;
    double distance;
    double vel;
    double acc;
