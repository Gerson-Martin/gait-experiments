...
//                getPathLegSwing(footSpec.lift,liftLeg,v4,200);
    ...
    profFootSingleCOM= new KDL::VelocityProfile_TrapHalf(pathFootSingleCOM->PathLength()/DURATION_ONE_STEP*2,0.1,true);
    ...
    comTraj.Add(new KDL::Trajectory_Stationary(0.5, comTraj.Pos(comTraj.Duration())));
    LegInFlightTraj.Add(new KDL::Trajectory_Stationary(0.5, LegInFlight));
    staticLegTraj.Add(new KDL::Trajectory_Stationary(0.5, staticLeg));
    return;
}
